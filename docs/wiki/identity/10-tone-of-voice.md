...
## Stem & toon — zeven kenmerken

### 1. Uitnodigend, niet missionerend

Begin met een uitnodiging, een feit of een mens. Niet met wat Leon *gelooft*
of *vindt*. De missie blijkt uit het werk, niet uit een mission statement.

- ✓ *"Op zondagochtend dansen we in de Beursschouwburg. Geen ervaring nodig. Kom een keer langs."*
- ✗ *"Leon gelooft in de kracht van participatieve dans als bindmiddel tussen culturen en generaties."*
...
### 3. Warm zonder zoetsappig

Je-vorm, menselijk, kort. Geen uitroeptekens-mode, geen "iedereen-welkom"-
zoetheid, geen feel-good-clichés. Warmte = nabijheid, niet enthousiasme.

- ✓ *"Geen ervaring nodig. Kom gewoon."*
- ✗ *"Iedereen is welkom op deze prachtige reis vol ontmoetingen en verbinding!"*
...
- ✓ *"Ik kan er mezelf zijn en ik ontmoet mensen die ik anders nooit zou tegenkomen."* — deelnemer, Mariage
- ✗ *"Een uniek en bekroond participatief project dat mensen op een diepgaande manier samenbrengt."*

### 5. Plain, niet schools

Gangbaar Nederlands. Vermijd vaktaal die alleen in onderwijs, beleid of
academie kent. Een buurtbewoner moet de pagina begrijpen zonder hulp.

- ✓ *"Een groep van twintig mensen die wekelijks samen dansen, naar één voorstelling toe."*
- ✗ *"Een laagdrempelig multidisciplinair traject met focus op intergenerationele co-creatie."*
...
- ✗ Op de project-pagina, voor iedereen: *"Voor deelnemers, programmatoren, partners en pers."*
...
- ✓ *"Wil je een project opzetten of de mobiele dansstudio boeken?"* (de twee acties zijn de links)
- ✗ *"Werk je aan een project? Daar hoort een eigen pagina bij: …"* (verwijst naar onze indeling i.p.v. naar de lezer)

---

## Stijl & ritme

- **Korte zinnen waar het kan.** Fragmenten ook, als het ritme erom vraagt.
  *"Geen ervaring nodig. Kom gewoon."* Een lange zin alleen als hij iets doet.
- **Actief, niet passief.** *"Leon organiseert het atelier op zondag"* > *"Het atelier wordt op zondag georganiseerd door Leon"*.
- **Werkwoord vroeg.** Niet de ambtelijke woordvolgorde waarbij het werkwoord
  pas achteraan komt. *"We dansen elke zondag in de Beursschouwburg"* >
  *"Het wekelijkse danssamenzijn vindt elke zondag in de Beursschouwburg plaats."*
- **Beelden boven bijvoeglijke naamwoorden.** *"Een dansatelier op zondagochtend
  in de Beursschouwburg"* zegt meer dan *"een laagdrempelig en inclusief atelier"*.
...
## Openers, hooks & afsluiters

### Page openers

Open met een uitnodiging, een feit of een mens. Nooit met *"Leon is een vzw die…"*.

- ✓ *"Op zondagochtend dansen we in de Beursschouwburg."* (uitnodiging)
- ✓ *"Sinds 2010 maakt Leon voorstellingen met de mensen die in Brussel wonen."* (feit)
- ✓ *"Hadja, 67, danste vorig jaar voor het eerst mee aan Mariage."* (mens)
- ✗ *"Leon vzw is een Brusselse organisatie die zich richt op de bevordering van…"*

### CTA's

Werkwoord aan het begin. Lage drempel. Geen klikbevehl.

- ✓ *"Kom een keer langs."* · *"Schrijf je in."* · *"Boek Leon."* · *"Plan een gesprek."*
- ✗ *"Klik hier voor meer informatie."* · *"Start uw aanvraag."* · *"Lees verder →"*
...
Blijf in stem. Een mens reageert, geen systeem.

- ✓ *"Hier staat nog niets. Stuur ons een mailtje als je iets zoekt: hallo@leon.dance."*
- ✗ *"Geen resultaten gevonden. Error 404."*
...
| **mensen die meedoen** | deelnemers (in de eerste publieksstap) | Warmer voor de eerste P1-aanraking; daarna mag *deelnemer*. |
| **vóór 10 september** | "binnenkort" · "in september" | Een datum is een belofte. |
| **gratis** | kosteloos · vrij van bijdrage | Eén lettergreep, geen subsidie-eufemisme. |
...
## Per-pagina aanpassingen op de website

De register-dial verschuift per pagina, in lijn met
[Structure](../design/30-structure.md). Hieronder welke kant op.
...
**Belonging dial.** Leid met de mens of het beeld. Praktische info (wanneer,
waar, voor wie, hoe inschrijven) hoog op de pagina. **Deelnemers-quote boven
pers-citaten.** Inschrijven als laatste sectie, niet als sales-blok.
...
3. **Concreet vroeg.** Komt het eerste concrete feit (datum, plaats, naam,
   getal) binnen de eerste twee zinnen?
4. **Tonen, niet claimen.** Wordt iets *getoond* (quote, getal, foto, datum)
   i.p.v. *geclaimd* (uniek, duurzaam, bekroond)?
5. **Verboden woorden eruit?** (Zie lijst hierboven.)
...
- **Wordt afgeklopt door:** Sam & Kristin op de content-complete draft
  ([Strategy S-02](../strategy/01-concerns.md)). Wijzigingen erna worden hier
  doorgevoerd; deze pagina blijft de werkende referentie tussen iteraties.
