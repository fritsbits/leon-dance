...
| **editie** (pl. *edities*) | One dated **staging/run** of a project — its own page, own *groep*, own dates (e.g. *Mariage @ Cultureghem, 10 apr*). | The unit P6 plans against and the live site already shows publicly ("Previous editions"). One word; the *page* it sits on changes what's emphasised (see copy notes). |
