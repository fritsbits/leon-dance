...
> **Ownership (anti-overlap contract).** This page owns the **job** (when→want→so-that).
> The **person** → [Personas](20-personas.md); the **promise** →
> [Value proposition](40-value-proposition.md); the **sequence over time** →
> [User journey](50-user-journey.md). Reference by stable ID; **never restate** the
> person/promise/flow.
...
- **Functional** — understand what/where/when + *"wat kan ik hier doen?"*
- **Emotional** — feel *"mensen zoals ik"*: permission to belong **before** being asked to
  parse a mission.
- **Social** — picture myself among these people without risking face.
- **Hired over what** — the default today is **bounce** (*"haakt af"* on missie/visie) —
  non-consumption — or ask someone who already goes.
...
- **Functional** — verify the *participatie* functie is genuinely filled.
- **Emotional** — feel safe defending the allocation.
- **Social** — be seen by co-assessors backing something **rigorous, not charity**.
- **Hired over what** — the dossier PDF alone; the site is the **corroborating evidence
  the decree explicitly counts** (own communication channels as proof).
...
- **Functional** — judge bookability (repertoire, tour history, what it needs).
- **Emotional** — confidence it won't be a reputational/logistical risk to programme.
- **Social** — be the programmer who brought a credible, distinctive participatory work.
- **Hired over what** — relationship-only or **not booking** (today only *"een paar beelden
...
- **Functional** — see the fit (cadence, who, what changes for the group).
- **Emotional** — trust it serves *their* mandate, not extra burden.
- **Social** — be able to justify it to leadership/team — that **it counts**
  (cf. "Leon" on the Cardijnschool report cards).
- **Hired over what** — not bringing it, or a different provider; today it's Leon-initiated
...
- **Functional** — date/place/practical essentials, fast.
- **Emotional (press)** — a usable angle they can stand behind (*"anderen schrijven over
  ons"*; the reliable hook = social, not aesthetic).
...
- **Job (light)** — delivering a freelance session → a shared *rode draad* + a reliable
  ...
  flag:** backstage/internal = later/light — *not deepened this phase by design*
  ([S-06](01-concerns.md)).

### N · kerngroep — *non-audience*
...
- **Pull** — the Kunstendecreet timing (*"de timing zit daar goed"*); the wish for **one
  place** that answers *waar / wanneer / welke activiteit / is dit iets voor mij*.
- **Anxiety** — the **org's own** scope/dependence fear (autonomy; *"ineens de site
  kapot"*) is a force on [G5](10-organisation-goals.md) — it shapes the build, not just
  the content.
- **Habit** — principled **no social media** (no time + an ethical stance): the site must
  **absorb the channel job** (a "dit is wat we doen" feed + newsletter capture) *without*
  social — a structural pull on the job, not an optional add-on.

## The cross-cutting decision: the shared "proof" job

P1, P2 and P3 **all hire the site for "proof" — but a different register**:

- **P1** wants *"is dit voor mij — mensen zoals ik"* (belonging).
- **P2** wants *methodical, durable, fundable* (institutional legitimacy).
...
[value proposition](40-value-proposition.md) and the next-phase Scope.

## Feeds

→ [Value proposition](40-value-proposition.md) (job → unique value per audience) ·
[User journey](50-user-journey.md) (the job over time).
