...
<style>
  ...
  *{box-sizing:border-box}
  ...
  .smap{display:grid;grid-template-columns:max-content 1fr;column-gap:24px;row-gap:2px;align-items:baseline;background:var(--panel);border:1px solid var(--line);border-radius:8px;padding:14px 16px;overflow:auto}
  .smap-branch{font-family:ui-monospace,Menlo,monospace;white-space:pre;font-size:12px}
  .smap-pre{color:var(--faint)}
  .smap-name{color:#111827;font-weight:500}
  .smap-ann{font-size:12px;color:var(--mut)}
  .smap-plain{grid-column:1/-1;font-family:ui-monospace,Menlo,monospace;white-space:pre;font-size:12px;color:var(--faint)}
  .smap-root{color:#111827;font-weight:600}
  .smap-gap{grid-column:1/-1;height:7px}
  .smap-notes{margin-top:14px;border-top:1px solid var(--line);padding-top:12px;display:grid;gap:8px}
  .smap-note{display:grid;grid-template-columns:190px 1fr;gap:16px;font-size:12px}
  .smap-note .k{color:var(--faint);text-transform:uppercase;letter-spacing:.04em;font-size:10px;font-weight:600;padding-top:2px}
  .smap-note .v{color:var(--mut)}
  ...
  .crow .cres{color:var(--mut);font-size:11px;margin-top:2px}
...
<div class="wrap">
  <header class="top">
    <h1>Leon — build status <span class="mono meta">/build</span></h1>
  ...
  <nav class="sections">
    <a href="#overzicht">@svg('heroicon-o-chart-bar', 'nav-ico') Overzicht</a>
    <a href="#structuur">@svg('heroicon-o-map', 'nav-ico') Structuur</a>
    <a href="#paginas">@svg('heroicon-o-document-text', 'nav-ico') Pagina's</a>
    <a href="#patronen">@svg('heroicon-o-squares-2x2', 'nav-ico') Patronen</a>
    <a href="#concerns">@svg('heroicon-o-flag', 'nav-ico') Concerns</a>
  </nav>
